...
#BREAK from the tutorial here, since splitting by underscore really screws up the names as I have more than one underscore per sample name
...
#NEW 08.30.21: use updated fitering and trimming parameters from a different tutorial.
...
#######step 14: assigning taxonomy
#first, need to download the latest Silva database: V138.1 as of 08.30.21
#make sure to download the train_set (for some reason)
...
#also do an additional step of species-level assignment, but only with 100% matches
...
head(taxa.print)
#looks... amazing. Anyway, a note from the tutorial:If your reads do not seem to be appropriately assigned, for example lots of your 
#bacterial 16S sequences are being assigned as Eukaryota NA NA NA NA NA, your reads may be in the opposite orientation as the reference database. 
...
#######step 14a: assigning taxonomy AGAIN
#why am I doing this? Because I don't understand what's going on here AT ALL and I need ids for generating an asv table
...
#######step 15: evaluate accuracy: CAN"T DO IT B/C HAVE NO MOCK COMMUNITY.

#######step 16: creating outputs
# giving our seq headers more manageable names (ASV_1, ASV_2...)
asv_seqs <- colnames(seqtab.nochim)
asv_headers <- vector(dim(seqtab.nochim)[2], mode="character") #this is totally unusable 
